...
const VideoPanel: React.FC<VideoPanelProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4 relative">
      ...
      <div className="group relative bg-[#0F0F11] border border-white/10 rounded-2xl overflow-hidden min-h-[300px] flex items-center justify-center transition-all bg-[url('/grid-pattern.png')]">
       ...
       <div className="flex items-center gap-3 p-1">
            {/* Model Info */}
            <div className="flex-1 bg-[#1a1a1c] border border-white/5 rounded-lg px-3 py-2 flex items-center justify-between">
                 <div className="flex items-center gap-4">
                    ...
                    <div className="w-px h-8 bg-white/10"></div>
                     ...
                     <div className="flex flex-col">
                        <span className="text-[9px] text-slate-500 font-mono uppercase">Target Model</span>
                        <span className="text-xs font-bold text-pink-400 font-mono truncate max-w-[120px]">
                 ...
                 <div className="flex items-center gap-2">
                     <button
                        ...
                        className="p-2 hover:bg-pink-500/10 rounded-lg text-slate-400 hover:text-pink-400 transition-colors"

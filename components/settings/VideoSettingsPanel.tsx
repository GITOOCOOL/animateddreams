...
const VideoSettingsPanel: React.FC<VideoSettingsPanelProps> = ({ 
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full flex flex-col pr-2">
        ...
        {/* Tab Navigation */}
        <div className="flex bg-slate-900/50 p-1 rounded-lg border border-white/5 mb-4 shrink-0">
            <button
                ...
                ${activeTab === 'gen' ? 'bg-pink-600 text-white shadow-lg' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5'}`}
            >
            ...
            <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md text-[10px] font-bold uppercase tracking-wider transition-all
                ${activeTab === 'workflow' ? 'bg-pink-600 text-white shadow-lg' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5'}`}
            >

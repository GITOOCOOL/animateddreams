...
export const DictationControl: React.FC<DictationControlProps> = ({
    ...
    return (
        <div className="absolute bottom-2 right-2 lg:bottom-4 lg:right-4 flex flex-row items-center gap-2 lg:gap-2 bg-card/80 backdrop-blur-sm border border-subtle rounded-xl p-2 lg:p-1.5 shadow-subtle z-20 max-w-[calc(100%-1rem)]">
            ...
            {/* Divider */}
            <div className="w-px h-3 lg:h-4 bg-subtle mx-1"></div>
            ...
            <div className="flex items-center gap-2">
                ...
                <button 
                    ...
                    className="p-2 lg:p-1.5 text-dim hover:text-main hover:bg-hover rounded-lg transition-colors flex-shrink-0 bg-transparent lg:bg-card/50"
                ...
                <button
                    ...
                    className={`flex items-center justify-center gap-1.5 lg:gap-2 px-3 lg:px-3 lg:py-1.5 rounded-lg text-[10px] lg:text-[10px] font-bold uppercase tracking-wider transition-all flex-shrink-0 w-auto
                        ${isRecording 
                            ...
                            : 'bg-hover text-dim hover:text-main'}

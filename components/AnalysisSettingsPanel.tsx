...
const AnalysisSettingsPanel: React.FC<AnalysisSettingsPanelProps> = ({ settings, onSettingsChange }) => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
             <div className="bg-purple-900/10 border border-purple-500/20 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                    <Brain className="w-5 h-5 text-purple-400 mt-0.5" />
                    <div>
                        <h4 className="text-xs font-bold text-purple-400 uppercase tracking-wider mb-1">Cortex Configuration</h4>
                        <p className="text-[10px] text-slate-400">Configure the reasoning parameters of the analysis engine.</p>
                    </div>
                </div>
             </div>
